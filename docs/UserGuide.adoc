...
* **`subscribe`**`l/http://rss.nytimes.com/services/xml/rss/nyt/World.xml ti/NYT World d/New York Times World News` : subscribes to the New York Times World News feed (this can take a while)
* *`list`* : goes back to your reading list
...
Format: `edit [ti/TITLE_SEARCH_PHRASE] [d/DESCRIPTION_SEARCH_PHRASE] [l/LINK_SEARCH_PHRASE] [t/TAG_TO_SEARCH]...`
