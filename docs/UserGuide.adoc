...
- `add https://www.theatlantic.com/magazine/archive/2019/03/ford-ceo-jim-hackett-ux-design-thinking/580438/ c/explains why UX is important t/Business` Adds a single link with a description and tagged with “Business”
...
- `edit 1 c/need to read again` Edits the description attached to the 1st link
...
- `add 1 c/explains why UX is important t/Business` Adds the 1st link with a description and tagged with “Business”
- `add 4-6 c/read by Monday t/School` Adds the 4th to 6th links with the same description and tagged with “School"
