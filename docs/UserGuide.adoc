...
- `search https://live.engadget.com/2019/02/08/microsoft-internet-explorer-technical-debt/` Returns all entries from this article `[coming in v2.0]`

=== Viewing a web feed: `feed` `[since v1.2]`

Opens a web feed at the URL for previewing. This command also enters the Search context.
...
Format: `subscribe URL [n/NAME] [t/TAG]...`
...
Format: `update all` `[coming in v2.0]`

Examples:

- `update all` Updates entries from all feeds `[coming in v2.0]`
