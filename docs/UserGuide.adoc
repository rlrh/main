...
Opens a web feed at the URL for previewing. This command also enters the Search Results context.
...
Lists all the links in a URL, or the currently displayed web page. This command also enters the Search Results context.
