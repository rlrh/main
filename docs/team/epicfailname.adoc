...
README lets users store webpages for offline reading and subscribe to feeds so that their favourite content is delivered to them.
...
*** Context switching: Users can make the application display different entries (saved entries, archived entries etc.)
...
=== *Code contributed*:
For an overview of all of the code contributed by me, refer to the CS2103T https://nus-cs2103-ay1819s2.github.io/cs2103-dashboard/#=undefined&search=epicfailname[module dashboard]!
...
* Community:
** Regularly review pull requests (PR) (see https://github.com/CS2103-AY1819S2-W10-1/main/pulls?utf8=%E2%9C%93&q=is%3Apr+reviewed-by%3Aepicfailname[here] for the complete list). PRs with non-trivial comments:
*** https://github.com/CS2103-AY1819S2-W10-1/main/pull/76[#76]
*** https://github.com/CS2103-AY1819S2-W10-1/main/pull/107[#107]
** Reported bugs and gave suggestions for another group's https://github.com/CS2103-AY1819S2-W11-3/main[project]:
...
|===
|Given below are sections I contributed to the User Guide. They showcase my ability to write documentation targeting end-users._
|===

include::../UserGuide.adoc[tag=contextcommands]
